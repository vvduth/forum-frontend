...
const CommentForm = () => {
  return (
    ...
    <h3 className="text-xl mb-8 font-semibold border-b pb-4">Login to like  comment</h3>
    <div className="grid grid-cols-1 gap-4 mb-4">
      <textarea value={''} onChange={()=>{}} className="p-4 outline-none w-full rounded-lg h-40 focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700" name="comment" placeholder="Comment" />
    </div>
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
      <input type="text" value={''} onChange={() =>{}} className="py-2 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700" placeholder="Name" name="name" />
